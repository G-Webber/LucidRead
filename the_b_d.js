...
for (var i = 0; i < html.length; i++){
    ...
    if (character == '>'){
        ...
        if (character == 'd'){
            if (is_entity){
                not_entity_str += "<span style=\"color: red;\">d</span>";
                is_entity_str += character;
            }
            else{
                new_html += "<span style=\"color: red;\">d</span>";
            }
            ...
            if (is_entity){
                is_entity_str += character;
                not_entity_str += "<span style=\"color: #61FF33;\">b</span>";
            }
            else{
            new_html += "<span style=\"color: #61FF33;\">b</span>";
            }
            d_positions.push((offsets + i));
            offsets = offsets+19;
            //console.log(d_positions);
